...
def usage():
    ...
    print('   This script contains a VerifMSI description of a circuit implementing the \'NI Mult\' algorithm from [1] with 7 shares.')
    print('Options:')
...
if __name__ == '__main__':
    nbLeak, nbCheck = ni_mult_7_shares(*sys.argv[1:])
