...
def usage():
    ...
    print('   This script generates a VerifMSI file describing the O-PINI1 gadget from [1].')
    print('Options:')
...
def usage():
    print('Usage: %%s [options]' %% os.path.basename(__file__))
    print('   This script contains a VerifMSI description of the O-PINI1 gadget from [1] with %d shares.')
