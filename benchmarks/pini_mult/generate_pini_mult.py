...
def usage():
    ...
    print('   This script generates a VerifMSI file describing a circuit implementing the PINI multiplication from [?].')
    print('Options:')
...
'''
    ...
    content += '''def usage():
    print('Usage: %%s [options]' %% os.path.basename(__file__))
    print('   This script contains a VerifMSI description of a circuit implementing the PINI multiplication from [?] with %d shares.')
