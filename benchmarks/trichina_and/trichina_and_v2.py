...
def usage():
    ...
    print('   This script contains a VerifMSI description of a circuit implementing the \'Trichina AND\' function (v2) from [1].')
    print('Options:')
...
if __name__ == '__main__':
    nbLeak, nbCheck = trichina_and_v2(*sys.argv[1:])
