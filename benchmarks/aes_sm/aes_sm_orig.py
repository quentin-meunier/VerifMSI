...
def mix_columns(state):
    ...
    for i in range(0, 16, 4):
        ...
        state[i]     = mul_02_t[temp[0]] ^ mul_03_t[temp[1]] ^          temp[2]  ^          temp[3]
        state[i + 1] =          temp[0]  ^ mul_02_t[temp[1]] ^ mul_03_t[temp[2]] ^          temp[3]
        state[i + 2] =          temp[0]  ^          temp[1]  ^ mul_02_t[temp[2]] ^ mul_03_t[temp[3]]
        state[i + 3] = mul_03_t[temp[0]] ^          temp[1]  ^          temp[2]  ^ mul_02_t[temp[3]]
